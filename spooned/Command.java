public class Command {
    ...
    public Command(java.util.Map<java.lang.Integer, Product> products) {
        System.out.println("Enter in the method <init> from class Command");;
    ...
    public void display() {
        System.out.println("Enter in the method display from class Command");;
    ...
    public void fetch(int id) throws java.lang.Exception {
        System.out.println("Enter in the method fetch from class Command");;
        Product result = null;
    ...
    public void add(Product product) throws java.lang.Exception {
        System.out.println("Enter in the method add from class Command");;
    ...
    public void delete(int id) throws java.lang.Exception {
        System.out.println("Enter in the method delete from class Command");;
    ...
    public void update(int id, java.lang.String name, int price, java.util.Calendar expiration_date) throws java.lang.Exception {
        System.out.println("Enter in the method update from class Command");;
        if (products.containsKey(id)) {
